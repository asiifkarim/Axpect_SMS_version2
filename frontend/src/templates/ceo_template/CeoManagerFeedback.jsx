...
const CeoManagerFeedback = () => {
  ...
  const filteredFeedback = feedback.filter(fb => {
    const manager = managers.find(mgr => mgr.id === fb.employee_id)
          ...
          <div className="col-md-12">
            <div className="card">
              <div className="card-header">
                <h3 className="card-title">Manager Feedback Management</h3>
              ...
              <div className="card-body">
                ...
                {showAddForm && (
                  <div className="card mb-4">
                    <div className="card-header">
                      <h4 className="card-title">Send Feedback to Manager</h4>
                    </div>
                    <div className="card-body">
                        ...
                        <div className="row">
                          <div className="col-md-6">
                            <div className="form-group">
                              <label htmlFor="employee_id">Select Manager *</label>
                              <select
                                className={`form-control ${errors.employee_id ? 'is-invalid' : ''}`}
                                id="employee_id"
                                {...register('employee_id', { required: 'Please select a manager' })}
                              >
                    ...
                    <table className="table table-bordered table-striped">
                      ...
                      <tbody>
                        {filteredFeedback.map(feedbackItem => {
                          const manager = managers.find(mgr => mgr.id === feedbackItem.employee_id)
                          return (
          ...
          {selectedFeedback && (
            <div>
              <Row className="mb-3">
                ...
                <Col md={6}>
                  <strong>To:</strong> {managers.find(emp => emp.id === selectedFeedback.employee_id)?.name || 'Unknown Manager'}
                </Col>
              </Row>
              <Row className="mb-3">
                <Col md={6}>
...
export default CeoManagerFeedback
