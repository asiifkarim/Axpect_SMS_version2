...
const CeoEmployeeLeave = () => {
  ...
  const filteredLeaveRequests = leaveRequests.filter(request => {
    const employee = employeesList.find(emp => emp.id === request.employee_id)
          ...
          <div className="col-md-6">
            <div className="card">
              <div className="card-header">
                <h3 className="card-title">Employee Leave Request Status</h3>
              </div>
...
export default CeoEmployeeLeave
