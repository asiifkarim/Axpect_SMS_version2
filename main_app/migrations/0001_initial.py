# Generated by Django 5.2.7 on 2025-10-03 23:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['employee', 'check_in_time'], name='main_app_gp_employe_10f1b5_idx'), models.Index(fields=['check_in_time'], name='main_app_gp_check_i_3c6c2b_idx')],
            },
        ),
        migrations.CreateModel(
            name='GPSRoute',
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-timestamp'],
                'indexes': [models.Index(fields=['employee', 'timestamp'], name='main_app_gp_employe_60c878_idx'), models.Index(fields=['timestamp'], name='main_app_gp_timesta_e8f26c_idx')],
            },
        ),
        migrations.AddIndex(
            model_name='jobcard',
