...
urlpatterns = [
    ...
    path("admin/communication-dashboard/", ceo_views.communication_dashboard, name='communication_dashboard'),
    path("admin/business-calendar/", ceo_views.business_calendar, name='business_calendar'),
    path("admin/business-calendar/add-holiday/", ceo_views.add_holiday, name='add_holiday'),
    path("admin/business-calendar/edit/<int:entry_id>/", ceo_views.edit_holiday, name='edit_holiday'),
    path("admin/business-calendar/delete/<int:entry_id>/", ceo_views.delete_holiday, name='delete_holiday'),
    path("admin/price-lists/", ceo_views.price_list_manage, name='price_list_manage'),
    path("admin/price-lists/add/", ceo_views.add_price_list, name='add_price_list'),
    path("admin/price-lists/edit/<int:price_list_id>/", ceo_views.edit_price_list, name='edit_price_list'),
    path("admin/price-lists/delete/<int:price_list_id>/", ceo_views.delete_price_list, name='delete_price_list'),
    path("admin/rate-alerts/", ceo_views.rate_alerts, name='rate_alerts'),
    path("admin/rate-alerts/create/", ceo_views.create_rate_alert, name='create_rate_alert'),
    path("admin/rate-alerts/edit/<int:alert_id>/", ceo_views.edit_rate_alert, name='edit_rate_alert'),
    path("admin/rate-alerts/delete/<int:alert_id>/", ceo_views.delete_rate_alert, name='delete_rate_alert'),
    path("admin/staff-capabilities/", ceo_views.staff_capabilities_matrix, name='staff_capabilities_matrix'),
    path("admin/staff-capabilities/update/", ceo_views.update_capabilities, name='update_capabilities'),
    path("admin/customer-capabilities/", ceo_views.customer_capabilities_matrix, name='customer_capabilities_matrix'),
    path("admin/customer-capabilities/update/", ceo_views.update_customer_capabilities, name='update_customer_capabilities'),
