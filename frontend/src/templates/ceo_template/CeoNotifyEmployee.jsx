...
const CeoNotifyEmployee = () => {
  ...
  const filteredNotifications = notifications.filter(notif => {
    const employee = employeesList.find(emp => emp.id === notif.recipient_id)
          ...
          <div className="col-md-12">
            <div className="card">
              <div className="card-header">
                <h3 className="card-title">Employee Notifications</h3>
              ...
              <div className="card-body">
                ...
                {showAddForm && (
                  <div className="card mb-4">
                    <div className="card-header">
                      <h4 className="card-title">Send Notification to Employee</h4>
                    </div>
                    <div className="card-body">
                        ...
                        <div className="row">
                          <div className="col-md-6">
                            <div className="form-group">
                              <label htmlFor="recipient_id">Select Employee *</label>
                              <select
                                className={`form-control ${errors.recipient_id ? 'is-invalid' : ''}`}
                                id="recipient_id"
                                {...register('recipient_id', { required: 'Please select an employee' })}
                              >
                    ...
                    <table className="table table-bordered table-striped">
                      ...
                      <tbody>
                        {filteredNotifications.map(notification => {
                          const employee = employeesList.find(emp => emp.id === notification.recipient_id)
                          return (
          ...
          {selectedNotification && (
            <div>
              <Row className="mb-3">
                ...
                <Col md={6}>
                  <strong>To:</strong> {employeesList.find(emp => emp.id === selectedNotification.employee_id)?.name || 'Unknown Employee'}
                </Col>
              </Row>
              <Row className="mb-3">
                <Col md={6}>
...
export default CeoNotifyEmployee
